...
class PackageResolver {
    ...
    def resolve() {
        ...
        if (project.hasProperty('resolvePlayServiceRepository') && project.getProperties().get('resolvePlayServiceRepository').equals(Boolean.TRUE)) {
    ...
    def resolveSdkTools() {
        ...
        if (match) {
            ...
            log.lifecycle "Latest available SDK tools version is $latestToolsRevision."
    ...
    def resolveBuildTools() {
        log.lifecycle 'Resolving build tools'
    ...
    def resolvePlatformTools() {
        log.lifecycle 'Resolving platform tools'
    ...
    def resolveCompileVersion() {
        log.lifecycle 'Resolving compile version'
    ...
    def resolveSupportLibraryRepository() {
        log.lifecycle("Resolving support library repository")
